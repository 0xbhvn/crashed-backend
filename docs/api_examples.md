...
curl -X GET "http://localhost:8000/api/games" | jq .

# Get games with pagination (page 2, 20 items per page)
curl -X GET "http://localhost:8000/api/games?page=2&per_page=20" | jq .

# Get games with timezone conversion
curl -X GET "http://localhost:8000/api/games" -H "X-Timezone: America/New_York" | jq .

# Get a specific game by ID
curl -X GET "http://localhost:8000/api/games/7962298" | jq .

# Get a specific game by ID with timezone conversion
curl -X GET "http://localhost:8000/api/games/7962298" -H "X-Timezone: America/New_York" | jq .
```
...
curl -X GET "http://localhost:8000/api/analytics/intervals/min-crash-point/10" | jq .

# Get occurrences of crash points >= 10 in 15-minute intervals over 48 hours
curl -X GET "http://localhost:8000/api/analytics/intervals/min-crash-point/10?interval_minutes=15&hours=48" | jq .

# Get occurrences of crash points >= 10 in sets of 10 games over last 1000 games
curl -X GET "http://localhost:8000/api/analytics/intervals/min-crash-point/10/game-sets" | jq .

# Get occurrences of crash points >= 10 in sets of 20 games over last 2000 games
curl -X GET "http://localhost:8000/api/analytics/intervals/min-crash-point/10/game-sets?games_per_set=20&total_games=2000" | jq .

# Get occurrences of multiple crash points in time intervals (batch request)
curl -X POST "http://localhost:8000/api/analytics/intervals/min-crash-points" \
...
curl -X POST "http://localhost:8000/api/analytics/intervals/min-crash-points/game-sets" \
  -H "Content-Type: application/json" \
  -d '{
    "values": [2, 5, 10, 20],
    "games_per_set": 20,
...
curl -X GET "http://localhost:8000/api/analytics/last-game/min-crash-point/10" | jq .

# Get the most recent game with a crash point floor exactly 10
curl -X GET "http://localhost:8000/api/analytics/last-game/exact-floor/10" | jq .

# Get the most recent game with a crash point <= 2
curl -X GET "http://localhost:8000/api/analytics/last-game/max-crash-point/2" | jq .

# Get the most recent games with crash points >= specified values (batch)
curl -X POST "http://localhost:8000/api/analytics/last-games/min-crash-points" \
  -H "Content-Type: application/json" \
  -d '{
    "values": [2, 5, 10, 20]
  }' | jq .
...
curl -X POST "http://localhost:8000/api/analytics/last-games/exact-floors" \
  -H "Content-Type: application/json" \
  -d '{
    "values": [1, 2, 5, 10]
  }' | jq .
...
# Get the most recent games with crash points <= specified values (batch)
curl -X POST "http://localhost:8000/api/analytics/last-games/max-crash-points" \
  -H "Content-Type: application/json" \
  -d '{
    "values": [1.5, 2, 5]
  }' | jq .
...
curl -X GET "http://localhost:8000/api/analytics/last-games/min-crash-point/10" | jq .

# Get the 20 most recent games with crash points >= 10
curl -X GET "http://localhost:8000/api/analytics/last-games/min-crash-point/10?limit=20" | jq .

# Get the 10 most recent games with crash points <= 2
curl -X GET "http://localhost:8000/api/analytics/last-games/max-crash-point/2" | jq .

# Get the 10 most recent games with crash point floor exactly 5
curl -X GET "http://localhost:8000/api/analytics/last-games/exact-floor/5" | jq .
```
...
curl -X GET "http://localhost:8000/api/analytics/occurrences/min-crash-point/10" | jq .

# Get occurrences of crash points >= 10 in the last 200 games
curl -X GET "http://localhost:8000/api/analytics/occurrences/min-crash-point/10?games=200" | jq .

# Get occurrences of crash points >= 10 in the last 1 hour
curl -X GET "http://localhost:8000/api/analytics/occurrences/min-crash-point/10?by_time=true" | jq .

# Get occurrences of crash points >= 10 in the last 3 hours
curl -X GET "http://localhost:8000/api/analytics/occurrences/min-crash-point/10?by_time=true&hours=3" | jq .

# Get occurrences of crash points <= 2 in the last 100 games
curl -X GET "http://localhost:8000/api/analytics/occurrences/max-crash-point/2" | jq .

# Get occurrences of crash points <= 2 in the last 1 hour
curl -X GET "http://localhost:8000/api/analytics/occurrences/max-crash-point/2?by_time=true" | jq .

# Get occurrences of floor value exactly 5 in the last 100 games
curl -X GET "http://localhost:8000/api/analytics/occurrences/exact-floor/5" | jq .

# Get occurrences of floor value exactly 5 in the last 2 hours
curl -X GET "http://localhost:8000/api/analytics/occurrences/exact-floor/5?by_time=true&hours=2" | jq .

# Get occurrences of multiple minimum crash points (batch)
curl -X POST "http://localhost:8000/api/analytics/occurrences/min-crash-points/batch" \
  -H "Content-Type: application/json" \
  -d '{
    "values": [2, 5, 10, 20],
    "games": 200,
...
curl -X POST "http://localhost:8000/api/analytics/occurrences/exact-floors/batch" \
  -H "Content-Type: application/json" \
  -d '{
    "values": [1, 2, 5, 10],
    "games": 200,
...
curl -X POST "http://localhost:8000/api/analytics/occurrences/max-crash-points/batch" \
  -H "Content-Type: application/json" \
  -d '{
    "values": [1.5, 2, 5],
    "games": 200,
...
curl -X GET "http://localhost:8000/api/analytics/series/without-min-crash-point/10" \
